...
alter table dilion_auth.opaque_handshakes drop constraint if exists opaque_handshakes_kind_check;
alter table dilion_auth.opaque_handshakes add constraint opaque_handshakes_kind_check
