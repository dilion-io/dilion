...
type Service interface {
	...
	ListRequests(ctx context.Context, f RequestFilter, p httpapi.ListParams) (httpapi.Page[Request], error)
	...
	ListConsentStates(ctx context.Context, f ConsentSegmentFilter, p httpapi.ListParams) (httpapi.Page[SubjectConsent], error)
	...
	ExportConsentAudience(ctx context.Context, purpose string, p httpapi.ListParams) (httpapi.Page[AudienceMember], error)
	...
	SearchUsers(ctx context.Context, q UserSearchQuery, p httpapi.ListParams) (httpapi.Page[UserMatch], error)
	...
	ListHolds(ctx context.Context, f HoldFilter, p httpapi.ListParams) (httpapi.Page[LegalHold], error)
}
