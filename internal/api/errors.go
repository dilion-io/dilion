...
type Problem struct {
	...
	Code     string              `json:"code" enum:"validation_failed,unauthenticated,permission_denied,not_found,conflict,idempotency_conflict,legal_hold_active,policy_violation,rate_limited,reauthentication_needed,insufficient_aal,internal" doc:"Machine-readable error code."`
