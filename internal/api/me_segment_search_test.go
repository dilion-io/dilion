...
func TestMeSurfaceScopesEverythingToTheTokenSubject(t *testing.T) {
	...
	svc := &fakePrivacy{
		...
		listRequests: func(_ context.Context, f privacy.RequestFilter, _ httpapi.ListParams) (httpapi.Page[privacy.Request], error) {
			listedFor = f.UserID
			return httpapi.Page[privacy.Request]{Items: []privacy.Request{}}, nil
		},
		updateConsent: func(_ context.Context, u string, ch privacy.ConsentChange) (*privacy.ConsentState, error) {
	...
	resp := tapi.Post("/privacy/v1/me/requests", bearer, map[string]any{"type": "EXPORT"})
...
func TestMeCancelHidesOtherSubjectsRequests(t *testing.T) {
	...
	own := sampleRequest()
	svc.getRequest = func(context.Context, string) (*privacy.Request, error) { return own, nil }
	svc.cancelRequest = func(context.Context, string) (*privacy.Request, error) { return own, nil }
...
func TestUpdateUserConsentRequiresConsentsWrite(t *testing.T) {
	svc := &fakePrivacy{
		updateConsent: func(_ context.Context, _ string, ch privacy.ConsentChange) (*privacy.ConsentState, error) {
			return &privacy.ConsentState{Purpose: ch.Purpose, Granted: ch.Granted,
				PolicyVersion: ch.PolicyVersion, UpdatedAt: time.Now()}, nil
		},
	}
...
func TestSearchUsersEndpoint(t *testing.T) {
	...
	svc := &fakePrivacy{
		searchUsers: func(_ context.Context, q privacy.UserSearchQuery, _ httpapi.ListParams) (httpapi.Page[privacy.UserMatch], error) {
			gotQuery = q
	...
	svc.searchUsers = func(context.Context, privacy.UserSearchQuery, httpapi.ListParams) (httpapi.Page[privacy.UserMatch], error) {
...
func TestListConsentStatesEndpoint(t *testing.T) {
	...
	svc := &fakePrivacy{
		listConsentStates: func(_ context.Context, f privacy.ConsentSegmentFilter, _ httpapi.ListParams) (httpapi.Page[privacy.SubjectConsent], error) {
			gotFilter = f
...
func TestExportConsentAudienceEndpoint(t *testing.T) {
	sink := &recordingSink{}
	svc := &fakePrivacy{
		exportAudience: func(_ context.Context, purpose string, _ httpapi.ListParams) (httpapi.Page[privacy.AudienceMember], error) {
