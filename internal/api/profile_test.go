...
func TestGetUserProfileAcceptsUserTokenWithPermission(t *testing.T) {
	sink := &recordingSink{}
	svc := &fakePrivacy{
		getProfile: func(_ context.Context, _ string, _ bool) (*privacy.Profile, error) {
			return maskedProfile(), nil
		},
	}
...
func TestRevealUserProfileReturnsFullAndRecordsReason(t *testing.T) {
	...
	var gotFull bool
	svc := &fakePrivacy{
		getProfile: func(_ context.Context, _ string, full bool) (*privacy.Profile, error) {
			gotFull = full
...
func TestUpdateUserProfilePassesSetAndRemove(t *testing.T) {
	...
	svc := &fakePrivacy{
		updateProfile: func(_ context.Context, _ string, set map[string]privacy.ProfileField, remove []string) (*privacy.Profile, error) {
