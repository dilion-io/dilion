...
- 모듈: `github.com/dilion-io/dilion`
- **API 표면 2종:**
...
{ "event_type": "user.deleted", "aggregate_id": "<user uuid>",
  "payload": { "user_id": "<uuid>", "requested_by": "admin" } }
```
...
전체 auth 표면(OAuth/MFA/SAML/passkey/OPAQUE), RS256+JWKS, export 파이프라인, retention 스캐너 배치화, immudb sink, 관리 콘솔.
